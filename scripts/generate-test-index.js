...
const playwrightReportExists = fs.existsSync(path.join(outputDir, 'playwright-report', 'index.html'));
    ...
    <div class="container">
        ...
        <div class="report-grid">
            <div class="report-card">
                ...
                <ul>
                    <li>🌐 ${playwrightReportExists ? '<a href="playwright-report/index.html">Playwright HTML Report</a>' : '<span class="unavailable">Playwright HTML Report</span>'} ${playwrightReportExists ? '<span class="status available">✓</span>' : '<span class="status unavailable">Not Generated</span>'}</li>
