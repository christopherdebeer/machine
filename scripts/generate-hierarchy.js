...
async function main() {
    ...
    const outputJsonFile = join(outputDir, 'doc-hierarchy.json');
    const outputTsFile = join(outputDir, 'doc-hierarchy.ts');
    ...
    // Write TypeScript module (for importing in React components)
    const tsContent = `// Auto-generated file - do not edit manually
// Generated by scripts/generate-hierarchy.js
...
`;
    ...
    console.log(`\n✅ Generated hierarchy:`);
    console.log(`   JSON: ${relative(projectRoot, outputJsonFile)}`);
    console.log(`   TypeScript: ${relative(projectRoot, outputTsFile)}`);
