                        ...
                        <div className="stage">
                            ...
                            <div className="stage-content">
                                ...
                                <Carousel slides={[
                                    {
                                        id: 'example-001',
                                        code: `machine "Solution Sketch" @Example
...
description: "A long and rambling description..."
version: '0.0.1';

foo parent "Parent Title" @Parent {
    description: "A long and rambling description for this parent and its children, but not the root"
    property: 23;
    anotherProp: true;
