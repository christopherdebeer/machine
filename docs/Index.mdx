...
ordering -involves-> supplier;`
            ...
            <section id="documentation" className="light">
                <div className="container">
                    ...
                    <div className="doc-grid">
                        <div className="doc-card">
                            ...
                            <p>Installation, quick start, and your first machine</p>
                            <a href="getting-started-index.html" className="doc-link">Get Started →</a>
                        </div>

                        <div className="doc-card">
                            <h3>Syntax Reference</h3>
                            <p>Complete language syntax - nodes, edges, attributes, types</p>
                            <a href="syntax-index.html" className="doc-link">Learn Syntax →</a>
                        </div>

                        <div className="doc-card">
                            <h3>CLI Tools</h3>
                            <p>Command-line interface for generation and execution</p>
                            <a href="cli-index.html" className="doc-link">Use CLI →</a>
                        </div>

                        <div className="doc-card">
                            <h3>API Reference</h3>
                            <p>Programmatic integration and library API</p>
                            <a href="api-index.html" className="doc-link">Explore API →</a>
                        </div>

                        <div className="doc-card">
                            <h3>Examples</h3>
                            <p>Practical patterns organized by use case</p>
                            <a href="examples-index.html" className="doc-link">Browse Examples →</a>
                        </div>

                        <div className="doc-card">
                            <h3>Documentation Archive</h3>
                            <p>Previous versions and legacy content</p>
                            <a href="archived-documentation.html" className="doc-link">View Archive →</a>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="cta">
                <div className="container">
                    ...
                    <a href="playground-mobile.html" className="btn">CodeMirror PLAYGROUND →</a>
                    <a href="playground.html" className="btn btn-secondary" style={{marginLeft: '12px'}}>Monaco PLAYGROUND →</a>
                </div>
            </section>
