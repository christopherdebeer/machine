...
<div style={{ marginTop: '4rem', padding: '3rem', background: 'var(--secondary)', color: 'white', borderRadius: '8px' }}>
    ...
    <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
        ...
        <a href="#" className="btn btn-secondary" style={{ background: 'var(--primary)', color: 'white' }}>DISCORD →</a>
        <a href="#" className="btn btn-secondary" style={{ background: 'var(--primary)', color: 'white' }}>TWITTER →</a>
    </div>
</div>
