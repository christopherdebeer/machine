...
```dy examples/styling/style-annotations.dygram
...
```dy examples/styling/style-attribute.dygram
Task process {
    style: {
        color: blue;
        shape: box;
...
```dy examples/styling/custom-styling.dygram
...
```dy examples/styling/complete-demo.dygram
...
```dy examples/styling/refined-ports.dygram
...
```dy examples/styling/multiple-styles.dygram
...
```dy examples/styling/edge-styling.dygram
...
```dy examples/styling/hide-labels.dygram
