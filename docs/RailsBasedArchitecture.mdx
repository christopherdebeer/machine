...
<PageLayout title="Rails-Based Architecture" description="Execution engine that combines automated transitions with intelligent agent decisions">
...
import agent analyzer from "analysis-machine.mach";
