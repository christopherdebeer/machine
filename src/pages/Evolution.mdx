            ...
            <header style={{height: 'auto', padding: '4rem 0'}}>
                <div className="container">
                    ...
                    <div className="title-block" style={{marginTop: '2rem'}}>
                        Evolution System<span className="accent">.</span>
                    </div>
            ...
            <section className="dark">
                <div className="container">
                    ...
                    <div style={{display: 'flex', gap: '2rem', flexWrap: 'wrap', marginTop: '2rem'}}>
                        <a href="api.html" className="btn">VIEW API DOCS →</a>
                        <a href="quick-start.html" className="btn btn-secondary">QUICK START →</a>
                        <a href="examples.html" className="btn btn-secondary">SEE EXAMPLES →</a>
                    </div>
                </div>
            </section>
