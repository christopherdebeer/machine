...
<ExampleLoader path="examples/advanced/annotations.dygram" height="300px" />
...
<ExampleLoader path="examples/advanced/multiplicity.dygram" height="300px" />
...
<ExampleLoader path="examples/advanced/dependency-inference.dygram" height="300px" />
...
<ExampleLoader path="examples/advanced/complete-example.dygram" height="300px" />
Comprehensive example combining all expressivity features:
...
<ExampleLoader path="examples/advanced/error-handling.dygram" height="300px" />
...
<ExampleLoader path="examples/advanced/optional-types.dygram" height="300px" />
