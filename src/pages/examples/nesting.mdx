...
<ExampleLoader path="examples/nesting/nested-2-levels.dygram" height="300px" />
Simple 2-level nesting structure demonstrating basic hierarchy.

### `nested-3-levels.dygram`

<ExampleLoader path="examples/nesting/nested-3-levels.dygram" height="300px" />
3-level nesting showing deeper hierarchies.

### `complex-nesting.dygram`

<ExampleLoader path="examples/nesting/complex-nesting.dygram" height="300px" />
Complex nesting with multiple branches up to 4 levels deep.

### `deep-nested-5-levels.dygram`

<ExampleLoader path="examples/nesting/deep-nested-5-levels.dygram" height="300px" />
Demonstrates 5-level deep nesting to test parser depth limits.

### `semantic-nesting-example.dygram`

<ExampleLoader path="examples/nesting/semantic-nesting-example.dygram" height="300px" /> ⭐ **Phase 1**
...
<ExampleLoader path="examples/nesting/state-modules-example.dygram" height="300px" /> ⭐⭐ **Phase 2**
...
<ExampleLoader path="examples/nesting/optional-types-example.dygram" height="300px" /> ⭐⭐⭐ **Phase 3**
