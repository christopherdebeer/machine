...
<ExampleLoader path="examples/documentation/notes-and-generics.dygram" height="300px" />
...
<ExampleLoader path="examples/documentation/complete-phase3.dygram" height="300px" />
Complete example combining advanced syntax features:
